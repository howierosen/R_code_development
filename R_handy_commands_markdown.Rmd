...
### Get value at specific position in a matrix	
...
### Subsetting a column based on the name	
...
### Apply a function to some data according to levels of another variable	
...
### Apply a function to some data specifying the data that goes into the function (or limiting the input)	

      with(data, expresssion) 
e.g.

with(my.data$diagnosis == “FTD”, mean(my.data$age))
